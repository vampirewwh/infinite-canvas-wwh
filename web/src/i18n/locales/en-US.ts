export default {
    ...
    agent: {
        ...
        state: { ready: "Ready", connectionRequired: "Enter the Local URL and Connect token", invalidUrl: "The Local URL is invalid", offline: "Offline", skillReadFailed: "Failed to read Skill", skillParseFailed: "Failed to parse Skill", requestFailed: "Local Agent request failed", requestTimeout: "The local Agent timed out. Try again." },
        ...
        connect: { pluginTitle: "Option 1: Use the Codex plugin", pluginText: "Install the Infinite Canvas plugin in the Codex app and launch the canvas through it. The plugin starts the local Agent and supplies the connection details automatically.", directTitle: "Option 2: Run the Agent directly", directText: "Without the Codex plugin, run the command below in a terminal, then return here to connect or enter the Local URL and Connect token manually.", commandCopied: "Command copied", pluginReminder: "Codex plugin note", pluginReminderText: "The tool list enters the Codex context and consumes additional tokens only after installing the Codex plugin or adding MCP manually. Running npx -y @basketikun/canvas-agent@latest alone does not install MCP.", removePlugin: "Remove plugin", removeMcp: "Remove manual MCP", copyCommand: "Copy command", title: "Connect local Agent", description: "Choose the connection method that fits your workflow.", webConnection: "Web connection", autoDiscover: "The Local URL and Connect token are discovered automatically by default. Enter them manually only if discovery fails.", disconnect: "Disconnect", connect: "Connect", localAddress: "Local address", urlPlaceholder: "For example http://127.0.0.1:17371", token: "Connection token", tokenPlaceholder: "Discover automatically or enter the Connect token", installTitle: "Local Agent is not running?", installText: "On Windows, copy the command below into PowerShell and press Enter. Install it once and the Agent keeps running in the background with no console window, and starts automatically at logon.", installCommand: "One-click install", installNotice: "The script only writes a hidden launcher, adds it to startup, and starts the local Agent in the background right away. On macOS / Linux, start it manually with one of the options above.", providerTitle: "Codex provider", providerDescription: "Codex providers imported from CC Switch. Switching applies the provider to the Codex bundled with the canvas and starts a new conversation, without touching your own Codex setup.", providerLoading: "Reading the CC Switch configuration…", providerFailed: "Could not read the CC Switch configuration. Make sure CC Switch is installed and has been opened at least once.", providerEmpty: "No Codex provider found in CC Switch.", providerCurrent: "In use", providerUse: "Switch", providerOfficial: "Official account login", providerSwitched: "Switched to “{{name}}”", providerSwitchFailed: "Failed to switch provider", providerNotice: "The canvas keeps its own Codex configuration directory (~/.infinite-canvas/codex-home). Switching only rewrites that copy and never touches your own ~/.codex; the previous files are backed up under ~/.infinite-canvas/codex-config-backups." },
